...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.header__mobile-menu-btn').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.header__menu--mobile').toggleClass('header__menu--open');
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('body').css({
    overflow: 'hidden'
  });
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.overlay').fadeToggle(1000);
});
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.overlay').on('click', function () {
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.close-modal').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.overlay').fadeOut(500);
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal').removeClass('modal--show');
});
jquery__WEBPACK_IMPORTED_MODULE_1___default()(function () {
  ...
  var openModal = function openModal() {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.header__menu--mobile').removeClass('header__menu--open');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.overlay').fadeIn(1000);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal').addClass('modal--show');
  };
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default().ajax({
      ...
      success: function success(response) {
        if (response.success) {
          ...
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-alert').slideDown();
          setTimeout(function () {
      ...
      error: function error(response) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-alert').slideDown();
        setTimeout(function () {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-alert').slideUp();
        }, 3000);
      }
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('#login-btn').on('click', function (e) {
    e.preventDefault();
    jquery__WEBPACK_IMPORTED_MODULE_1___default().ajax({
      url: '/login',
      type: "POST",
      data: jquery__WEBPACK_IMPORTED_MODULE_1___default()("#login-form").serialize(),
      headers: {
        'X-CSRF-TOKEN': jquery__WEBPACK_IMPORTED_MODULE_1___default()('meta[name="csrf-token"]').attr('content')
      },
      success: function success(response) {
        if (response.success) {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-alert').empty();
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-alert').html('<div class="alert alert-success">Вы успешно вошли. Перенаправляем вас в кабинет...</div>');
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('.modal-alert').slideDown();
          document.location = '/user/account';
        }
      },
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).on("scroll", function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).scrollTop() > 40) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.header').addClass('header--sticky');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.header').removeClass('header--sticky');
  }
});
